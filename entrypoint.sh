...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/b0bd6fd7-db98-4f7d-b7cf-a6cc63c9ebfa-vless"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="b0bd6fd7-db98-4f7d-b7cf-a6cc63c9ebfa"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/75a58911-2c2d-4308-a2b6-2e8f4ed70f27-Vmess"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="75a58911-2c2d-4308-a2b6-2e8f4ed70f27"
fi
echo ${Vmess_UUID}
